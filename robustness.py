...
def related():# 城市文件列表（相对路径，相对于脚本所在目录）
    city_files = [
        "cases/Chengdu_Edgelist.csv",
        "cases/Dalian_Edgelist.csv",
        "cases/Dongguan_Edgelist.csv",
    ...
    for city_file in city_files:
        ...
        plot_strenth_curve(city_name, grid_line, output_dir="performance_data",compare=True,adjusted=True)
